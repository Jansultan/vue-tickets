...
export default {
  ...
  getters: {
    ...
    filteredList(state) {
      ...
      // console.log(state.tickets.flights);
      // console.log("state.switch_filter = ", state.switch_filter);
      ...
      if (state.switch_filter === 0) {
          ...
          filter_check = state.tickets.flights.filter((ticket) => {
            if (
              ...
              if (
                ...
                ticket.itineraries[0][0].segments[0].baggage_options[0].value >
                  0 &&
              ...
              if (state.filter_tariff.baggage === true) {
                if (
                  ticket.itineraries[0][0].segments[0].baggage_options[0]
                    .value > 0
                ) {
                  return ticket;
                }
        ...
        if (state.filter_comp[0] === "all") {
          ...
          return filter_check.filter((ticket) => {
            //   console.log(ticket.itineraries[0][0].segments[0]);
